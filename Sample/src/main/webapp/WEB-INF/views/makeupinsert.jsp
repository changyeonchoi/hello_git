    			...
    			<h2>Make Up 상품 등록하기</h2>
    				<div>1. 게시글 정보</div><br>
    					...
    					<table border="1" style="width: 70%;">
            				...
            				<tr>
                				<td class="black-cell">업체 사이트*</td>
                				<td><input type="text" class="input_text" id="detail_url" value=""></td>
            				</tr>
            				<tr>
                				<td class="black-cell">업체명*</td>
                        		<td><input type="text" class="input_text" id="company_name" value=""></td>
            				</tr>
            				<tr>
...
//         }
    ...
    $("#saveButton").click(function() {
        ...
        var company_yn = $("input[name='company_yn']:checked").val(); // Get the selected radio button value
         ...
         // 필수 입력 필드 체크
        if (!banner_title || !product_name || !file_img || !detail_url || !company_name || !company_phone || !company_yn) {
            alert("모든 항목을 입력해주세요.");
    ...
    $("#listButton").click(function() {
        // 목록 페이지로 이동
        window.location.href = '/makeuplist'; // 목록 페이지 URL로 변경해주세요
    });
