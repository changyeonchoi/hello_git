    					...
    					<table border="1" style="width: 70%;">
            				...
            				<tr>
                				<td class="black-cell">이미지등록*</td>
                       			<td>
									<div class="filebox">
									    <input class="upload-name" value="${makeup.file_img}" placeholder="파일선택">
									    <label for="file_img" class="file-label">이미지 찾기</label> 
    									<input type="file" id="file_img" value="${makeup.file_img}" accept=".png, .jpeg, .jpg" data-width="540" data-height="500">
